/**
 * @return {[esta função faz leitura dos valores urls.json e cria seus campos em tela conforme consultado o devido link que esta no json.]}
 */
(function(){
...
/**
 * @return {[está função encurta os link e retorna seu valor conforme esta no json, caso este valor esteja no json.]}
 */
function encurtar(){
